...
//   passhref true mean if you applying link tag to a whole box then you can select whether you want to allow the link tag to use in element or not .
          ...
          <div className="lg:w-1/2 md:w-1/2 p-4 w-full cursor-pointer shadow-lg m-5"> 
                <section className="relative rounded overflow-hidden flex justify-center ">
                 <img
                  alt="ecommerce"
                  className="m-auto md:mx-0 h-[30vh] md:h-[36vh] block object-left"
